//has an index function for displaying the site welcome page
...
exports.book_create_post = [
    ...
    //Prpcess request after validation and sanitization
    (req, res, next) => {
      ...
      var book = new Book(
        ...
        if (!errors.isEmpty()) {
          ...
          async.parallel({
            ...
            //<ark our selected genres as checked
          ...
          //Data form from is valid save book
...
exports.book_delete_post = function(req, res, next) {
    ...
    async.parallel({
      ...
      if (results.book_bookinstances.length > 0) {
        //Book has book instances, cannot delete
        res.render('book_delete', {title: 'Delete Book', book: results.book, book_instances: results.book_bookinstances});
      }
      else {
        //No instances so delete
...
exports.book_update_post = [
  ...
  (req, res, next) => {
    if(!(req.body.genre instanceof Array)) {
      ...
      req.body.genre=new Array(reqq.body.genre)
    }
    next();
  },
